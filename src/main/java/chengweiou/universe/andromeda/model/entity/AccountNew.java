...
@Data
public class AccountNew implements NotNullObj, Serializable {
    private Long id;
    ...
    public static final AccountNew NULL = new Null();
    private static class Null extends AccountNew implements NullObj {
    }
}
